...
TrainDataPath = "..\\mD_Data\\data16\\train\\"
ValDataPath = "..\\mD_Data\\data16\\val\\"
EvalDataPath = '..\\mD_Data\\data16\\evaluate\\'
...
if __name__ == '__main__':
    ...
    stop_val = keras.callbacks.EarlyStopping(monitor='val_loss',
                                             ...
                                             verbose=0,
                                             mode='auto')
    modelname = 'model_mD_ff' + getTimeString(timestamp)
    ...
    logger.info(modelname + ' is create by ' +
                sys.argv[0])
    logger.info('get mD by finite frequenct')
    logger.info('-' * 49)
