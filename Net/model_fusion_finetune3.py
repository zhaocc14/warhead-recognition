...
def createModel():
    ...
    HRRP_model.load_weights('model\\model_HRRP1912111754\\weights.ckpt')
    mD_model = create_mD_model()
    mD_model.load_weights('model\\model_mD1912111754\\weights.ckpt')
...
if __name__ == '__main__':
    ...
    model.compile(loss='categorical_crossentropy',
                  optimizer=keras.optimizers.SGD(lr=0.01, momentum=0.9, decay=0.4, nesterov=False),
                  metrics=['accuracy'])
